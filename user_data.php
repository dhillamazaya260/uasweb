                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                        <img src="images/<?= $row["foto"] ?>" width="100">
                                <?php
                                    }
                                }
                                ?>
            ...
            <form method="post" action="" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="username" placeholder="Tuliskan Username Anda" value="<?= $row["username"] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="floatingTextarea2">Password</label>
                        <textarea class="form-control" placeholder="Tuliskan Password Anda" name="password" required><?= $row["password"] ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        if ($row["foto"] != '') {
                            if (file_exists('images/' . $row["foto"] . '')) {
                        ?>
                                <br><img src="images/<?= $row["foto"] ?>" width="100">
                        <?php
                            }
                        }
                        ?>
...
<nav class="mb-2">
    ...
    <?php
        ...
        $start_number = ($hlm > $jumlah_number)? $hlm - $jumlah_number : 5;
