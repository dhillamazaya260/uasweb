...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" target="_blank" href=".">Lunar Universe</a>
        <button
    ...
    <div>
        <a href="https://www.instagram.com/its.zheyya"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://twitter.com/udinusofficial"
        ><i class="bi bi-twitter h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6282323514257"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Dhilla Mazaya Nasucha &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
